...
Shield adapter for the Particle Boron LTE-M board which integrates and ESP-32WROVER WiFi module, and microSD storage over SDIO interface. Boron and ESP-32 communicate over a split UART and SPI interface.
